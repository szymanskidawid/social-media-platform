    ...
    if (selection === "loginView") {
      return (
        <form method="POST">
          ...
          <button type="submit" onClick={() => setPage("main")}>Login</button>
          <p onClick={() => setLoginPageView("forgotPasswordView")}>Forgot password?</p>
          <p onClick={() => setLoginPageView("registerView")}>Don't have an account? Time to register!</p>
        </form>
      )
      ...
      return (
        <form method="POST">
          ...
          <button type="submit" onClick={() => setPage("main")}>Register</button>
        </form>
      )
    }
  }
